//Main tab / StellarisWheeStat5_4b sketch
...
float resW = 0.3;            // 1.202 resistance of wiper on digital pot in Kohm from MCP spec sheet
int corr = 4;              // adjustment to offset, determined as value that gives best zero data in resistor test
...
#define stir_pin PB_2           // stirring motor attached to pin PB_2 (19)?
